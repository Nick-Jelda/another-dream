...
*(Le lien écrit dans les informations du repo n'est plus à jour, c'est le lien ci-dessus qui le remplace)*
...
Le jeu est hébergé à l'adresse [sunny-foxes.itch.io/another-dream](https://sunny-foxes.itch.io/another-dream). Ce lien permet de jouer directement dans votre navigateur, sans installation. Pour plus d'informations sur le fonctionnement du jeu, n'hésitez pas à vous reporter au fichier [DOCS.md](https://github.com/paradoxe-tech/another-dream/blob/main/DOCS.md) de ce dépôt, de préférence après avoir joué au jeu pour profiter au maximum de l'immersion !
...
- [Un trailer](https://www.youtube.com/watch?v=KLG8026L2Dc&pp=ygUndHJhaWxlciBnYW1lcyBvbiB3ZWIgMjAyNSBhbm90aGVyIGRyZWFt), qui présente le jeu en adoptant un style promotionnel ;
- et [une vidéo plus technique](https://www.youtube.com/watch?v=4vRg3gf-yrA&pp=ygUndHJhaWxlciBnYW1lcyBvbiB3ZWIgMjAyNSBhbm90aGVyIGRyZWFt), qui se focalise davantage sur la décomposition du gameplay et de l'interface du jeu, en rentrant plus dans les détails.

## Crédits 

Ce jeu a été réalisé par Gaïa Durand ([@gaiadrd](https://github.com/gaiadrd)), Eloi Rathgeber-Kivits ([@greensunsmash](https://github.com/greensunsmash)) et Mathéo Moreau ([@paradoxe-tech](https://github.com/paradoxe-tech)), étudiants en deuxième année de Licence d'Informatique à l'Université Côte d'Azur, dans le cadre de l'édition 2025 du concours [Games On Web](https://github.com/gamesonweb) sur le thème "Dreamland". [Le dépôt original du jeu est disponible ici.](https://github.com/paradoxe-tech/another-dream)
